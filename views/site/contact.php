                                    ...
                                    <div class="switch-tab-view_2 grid-flex">
                                                    ...
                                                    <div class="grid-flex pt-2">
                                                        ...
                                                        <div class="design-discussion grid-flex grid-flex-1 grid-height-100 grid-width-100 ml-1">
                                                            <div class="award  grid-flex grid-flex-1 grid-col">
                                                                ...
                                                                <div class="grid-flex">
                                                                    <div class="datacat_order_today ml-2 mr-2"></div>
                                                        ...
                                                        <div class="design-discussion grid-flex grid-flex-1 grid-height-100 grid-width-100 ml-1">
                                                            <div class="award  grid-flex grid-flex-1 grid-col">
                                                                ...
                                                                <div class="today">Percent (30%)</div>
                                                    ...
                                                    <div class="grid-flex pt-2">
                                                        ...
                                                        <div class="design-discussion grid-flex grid-flex-1 grid-height-100 grid-width-100 ml-1">
                                                            <div class="award  grid-flex grid-flex-1 grid-col">
                                                                ...
                                                                <div class="today">Order</div>
                                                                <div class="grid-flex">
                                                                    <div class="datacat_order_day ml-2 mr-2"></div>
                                                                    <i class="fab fa-amazon-pay"></i>
                                                                </div>
                                        ...
                                        <div class="switch-tab-content_2 grid-flex  grid-col">
                                            ...
                                            <div class="grid-flex mt-2 grid-flex grid-flex-1 ">
                                                ...
                                                <div class="graph grid-flex grid-flex-3 grid-col">
                                                    <canvas id="bar-chart-grouped3" width="800" height="500"></canvas>
                                                    ...
                                                    <div class="grid-flex pt-2">
                                                        ...
                                                        <div class="design-discussion grid-flex grid-flex-1 grid-height-100 grid-width-100 ml-1">
                                                            <div class="award  grid-flex grid-flex-1 grid-col">
                                                                ...
                                                                <div class="grid-flex">
                                                                    <div class="datacat_order_month ml-2 mr-2"></div>
                                                                    <i class="fab fa-amazon-pay"></i>
                                                                </div>
                                        ...
                                        <div class="switch-tab-content_2 grid-flex  grid-col">
                                            ...
                                            <div class="grid-flex mt-2 grid-flex grid-flex-1 ">
                                                ...
                                                <div class="graph grid-flex grid-flex-3 grid-col">
                                                    <canvas id="bar-chart-grouped4" width="800" height="500"></canvas>
                                                    <div class="label-graph1 grid-flex" style="background: white"></div>
                                                    ...
                                                    <div class="grid-flex pt-2">
                                                        ...
                                                        <div class="design-discussion grid-flex grid-flex-1 grid-height-100 grid-width-100 ml-1">
                                                            <div class="award  grid-flex grid-flex-1 grid-col">
                                                                <div class="today">Order</div>
                                                                <div class="grid-flex">
                                                                    <div class="datacat_order_year ml-2 mr-2"></div>
                                                                    <i class="fab fa-amazon-pay"></i>
                                                                </div>
...
<?php JSRegister::begin() ?>
    <script>
        ...
        $('.datacat_order_today').html(cat_today.order)
        ...
        $('.datacat_order_day').html(cat_day.order)
        ...
        $('.datacat_order_month').html(cat_month.order)
        ...
        $('.datacat_order_year').html(cat_year.order)
