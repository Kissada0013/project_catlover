...
?>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'mergeHeader' => true,
                        'value' => function ($data) {
                            return Helper::changeDateToDateThai($data->pickup_date);
                        },
                    ],
    ...
    width: 45%;
    padding: 0px 5px;
    border-radius: 5px;">'. \app\models\Order::typeIntToDelivery($model->status_delivery) .' </label>
    ...
    border-radius: 5px;">'. \app\models\Order::typeIntToDelivery($model->status_delivery) .' </label>
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if ($model->status_delivery == User::STATUS_NOT_ACTIVE) {
                                return ' <input id="check-status" type="checkbox" checked data-toggle="toggle" data-index="' . $model->id . '" data-status="1"/>
