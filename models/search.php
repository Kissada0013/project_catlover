...
class search extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'username','lastname','img_path','img_name', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    {
        $query = User::find()->where('status != "'.User::STATUS_DELETE.'"');
